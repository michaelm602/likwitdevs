/*
 * Adapted from React Bits Beams by David Haz.
 * Source: https://github.com/DavidHDev/react-bits/tree/main/src/content/Backgrounds/Beams
...
function CanvasWrapper({ children, paused }) {
    return (
        <Canvas
            dpr={[1, 1.5]}
...
function createStackedPlanesBufferGeometry(count, width, height, spacing, heightSegments) {
...
const MergedPlanes = forwardRef(
    ({ material, width, count, height, paused }, forwardedRef) => {
...
const PlaneNoise = forwardRef((props, forwardedRef) => (
    <MergedPlanes
        ref={forwardedRef}
...
function DirectionalLight({ position, color }) {
...
export default function ReactBitsBeams({
    beamWidth = 2,
    beamHeight = 15,
    beamNumber = 12,
    lightColor = "#ffffff",
