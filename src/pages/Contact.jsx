        ...
        try {
            const leadRef = await createPublicLead({
                lead: {
                    ...
                    analyticsSchemaVersion: attribution.analyticsSchemaVersion,
                    analyticsReleaseId: attribution.analyticsReleaseId,
                    acquisitionSource: attribution.acquisitionSource,
                    selfReportedSource: leadSource,
                    canonicalLandingPage: attribution.canonicalLandingPage,
                    conversionLocation: attribution.conversionLocation,
                    submissionSurface: source,
                },
                analytics: {
                    serviceIntent: intent,
                    metadata: {
